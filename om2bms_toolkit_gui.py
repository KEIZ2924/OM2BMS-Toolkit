...
class ConverterTab:
    ...
    def _build(self):
        ...
        # ===== 转换模式 =====
        mode_box = ttk.LabelFrame(left, text="转换模式", style="Card.TLabelframe", padding=10)
        ...
        # ===== 文件路径 =====
        path_box = ttk.LabelFrame(left, text="文件路径", style="Card.TLabelframe", padding=10)
        ...
        input_btn_row = ttk.Frame(path_box)
        ...
        # ===== 转换选项 =====
        option_box = ttk.LabelFrame(left, text="转换选项", style="Card.TLabelframe", padding=10)
        ...
        app.offset_entry.grid(row=2, column=0, sticky="ew", padx=(0, 8), pady=(4, 0))

        judge_frame = ttk.Frame(option_box)
        judge_frame.grid(row=2, column=1, sticky="nw", padx=(0, 8), pady=(4, 0))
        ...
        for i, label in enumerate(JUDGE_OPTIONS.keys()):
            ...
            btn.grid(row=i // 2, column=i % 2, sticky="w", padx=(0, 10), pady=1)
        ...
        app.tn_entry.grid(row=2, column=2, sticky="ew", pady=(4, 0))

        # ===== 难度分析 =====
        analysis_box = ttk.LabelFrame(left, text="难度分析", style="Card.TLabelframe", padding=10)
        ...
        ttk.Label(analysis_box, text="目标").grid(row=0, column=1, sticky="w")

        frame = ttk.Frame(analysis_box)
        frame.grid(row=1, column=0, sticky="nw", pady=(4, 0))
        ...
        app.analysis_target_entry.grid(row=1, column=1, sticky="ew", padx=(8, 0), pady=(4, 0))

        # ===== 操作区 =====
        action_box = ttk.LabelFrame(left, text="开始执行", padding=10)
        ...
        log_box = ttk.LabelFrame(right, text="运行日志", padding=8)
